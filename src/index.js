 ...
 * given a delay time and the hole where the mole is hidden. */
...
/** dds or removes the 'show' class that is defined in styles.css to a given hole. It returns the hole. */
...
/** added popup funtion, it shows popup after 10 points. */
function checkScore() {
  if (points >= 10) {
